...
const Header = () => {
  ...
  return (
    <>
      <header className="sticky top-0 inset-x-0 z-50 bg-card/80 backdrop-blur-sm border-b border-border pt-[env(safe-area-inset-top)] px-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)]">
