...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-[env(safe-area-inset-top)] z-50 bg-card/80 backdrop-blur-sm border-b border-border px-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)]">
