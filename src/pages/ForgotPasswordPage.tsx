...
const ForgotPasswordPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-secondary/10 pt-[calc(env(safe-area-inset-top)+1rem)] px-4 pb-4">
      <Card className="w-full max-w-md">
        <CardHeader>
