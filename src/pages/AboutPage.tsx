        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-0 shadow-card bg-card/50 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6">
              ...
              <p className="text-muted-foreground leading-relaxed">Platforma noastră conectează utilizatorii cu o gamă largă de facilități sportive - de la terenuri de fotbal și tenis, până la piscine și terenuri de padel. Oferim o experiență de rezervare simplă, transparentă și sigură, atât pentru sportivi cât și pentru proprietarii de facilități.</p>
              <p className="text-muted-foreground leading-relaxed">
