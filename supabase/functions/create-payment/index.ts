...
serve(async (req) => {
  ...
  try {
    ...
    let sessionConfig: any = {
      ...
      mode: "payment",
      success_url: `https://ukopxkymzywfpobpcana.supabase.co/payment-success?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `https://ukopxkymzywfpobpcana.supabase.co/payment`,
      metadata: {
        facilityId,
        date,
        time,
