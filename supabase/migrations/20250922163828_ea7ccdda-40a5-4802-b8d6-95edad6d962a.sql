...
DROP FUNCTION public.get_facility_for_payment_secure(uuid);

CREATE OR REPLACE FUNCTION public.get_facility_for_payment_secure(
...
BEGIN
  ...
  SELECT 
    ...
    -- Expose full address for payment summary
