-- Add sports_complex_description to facility query functions
...
-- Recreate get_facilities_for_public_browsing_safe with sports_complex_description
...
-- Recreate get_facilities_for_authenticated_users with sports_complex_description
