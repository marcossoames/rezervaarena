...
-- 2. Drop existing triggers if they exist and recreate them
...
DROP TRIGGER IF EXISTS booking_integrity_trigger ON public.bookings;
DROP TRIGGER IF EXISTS client_booking_stats_trigger ON public.bookings;

-- Create triggers to activate booking validation functions
