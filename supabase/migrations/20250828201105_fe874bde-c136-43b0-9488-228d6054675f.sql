...
-- 1. Drop existing functions to change their signatures
...
-- 2. Create secure version of get_facilities_for_authenticated_users without phone numbers
...
-- 3. Create secure public browsing function
...
-- 4. Create a dedicated function for booking context that includes contact info
