...
DROP POLICY IF EXISTS "Authenticated users can view facility images for active facilities" ON public.facility_images;
...
DROP POLICY IF EXISTS "Authenticated users can view facility services for active facilities" ON public.facility_services;
