-- Drop existing functions to add general_services parameter
DROP FUNCTION public.get_facilities_for_public_browsing_safe();
DROP FUNCTION public.get_facilities_for_authenticated_users();

-- Create updated get_facilities_for_public_browsing_safe with general_services
...
-- Create updated get_facilities_for_authenticated_users with general_services
