-- Drop and recreate functions to include allowed_durations for duration filtering

-- Drop existing functions to allow structure change
...
-- Recreate public browsing function with allowed_durations
...
-- Recreate authenticated users function with allowed_durations
