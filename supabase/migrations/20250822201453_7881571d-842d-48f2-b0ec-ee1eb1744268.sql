...
CREATE POLICY "facility_images_upload_policy" 
ON storage.objects 
FOR INSERT 
TO authenticated
WITH CHECK (
...
CREATE POLICY "facility_images_update_policy" 
ON storage.objects 
FOR UPDATE 
TO authenticated
USING (
...
CREATE POLICY "facility_images_delete_policy" 
ON storage.objects 
FOR DELETE 
TO authenticated
USING (
...
CREATE POLICY "facility_images_select_policy" 
ON storage.objects 
FOR SELECT 
TO authenticated
