-- Drop and recreate get_facilities_for_public_browsing_safe with amenities
...
BEGIN
  ...
  SELECT 
    ...
    f.amenities, -- Include amenities for clients to see facility features
    f.created_at
