-- Drop the existing function and recreate it with email support
DROP FUNCTION get_client_info_for_facility_bookings(uuid);

-- Create the updated function that includes client email addresses
